...
class make_model:
	...
	def __init__(self,checkpoint_dir,checkpoint_addr,log_csv_addr,tensorboard_logs,
		train_keys_path,path_to_data,val_frac,final_model_path,mode,threshold_path,img_path,restore):
	...
	def summarize(self):
		...
		plot_model(self.model,to_file=self.img_path)
...
if __name__=='__main__':
	...
	for mode in modes:
		...
		img_path=os.path.join(output_data_path,'model.png')
		...
		mymodel=make_model(checkpoint_dir=checkpoint_dir,checkpoint_addr=checkpoint_addr,log_csv_addr=log_csv_addr,
			tensorboard_logs=tensorboard_logs,img_path=img_path,mode=mode,threshold_path=threshold_path,train_keys_path=train_keys_path,path_to_data=path_to_data,val_frac=val_frac,final_model_path=final_model_path,restore=restore)
		mymodel.train_model()
